...
public class JdbcInventoryDao implements InventoryDao {
    ...
    public Wishlist createWishlist(Wishlist wishlist) {
        String sql = "INSERT INTO wish_list (user_id, name, date_created) " +
                "VALUES (?, ?, ?) RETURNING id";
        Integer newId = jdbcTemplate.queryForObject(sql, Integer.class, wishlist.getUserId(),
                wishlist.getName(), wishlist.getDateCreated());
