...
public class ConsoleService {
    ...
    public String promptUserForNewWishlistName() {
        System.out.print("New wishlist name >>>");
    ...
    public void tellUserWishlistWasCreated(Wishlist wishlist) {
        System.out.println("Your new wishlist, " + wishlist.getName()
                + " was created with id " + wishlist.getId());
    }
}
