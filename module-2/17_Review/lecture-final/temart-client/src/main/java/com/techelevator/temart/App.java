...
public class App {
    ...
    private void handleLogin() {
        ...
        if (currentUser == null) {
            ...
            storeService = new StoreService(API_BASE_URL, currentUser);
        }
    }
	...
	private void createWishlist() {
		String newWishlistName = consoleService.promptUserForNewWishlistName();
        Wishlist createdWishlist = storeService.addNewWishlist(newWishlistName);
		consoleService.tellUserWishlistWasCreated(createdWishlist);
	}
