...
CREATE TABLE product_wish_list (
	...
	VALUES ('user1','','USER'), ('user2','','USER'), ('user3','','USER');
    ...
    -- Insert wishlists
    -- User 1 has 1 wishlist
    -- User 2 has 2 wishlists
    -- User 3 has no wishlist
    INSERT INTO wish_list (name, user_id, date_created) VALUES ('Test Wishlist 1', 1, '2022-06-15');    -- id 1
    INSERT INTO wish_list (name, user_id, date_created) VALUES ('Test Wishlist 2', 2, '2022-07-01');    -- id 2
    INSERT INTO wish_list (name, user_id, date_created) VALUES ('Test Wishlist 3', 2, '2022-07-04');    -- id 3
