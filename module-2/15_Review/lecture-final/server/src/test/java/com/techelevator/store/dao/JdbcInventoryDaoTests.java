...
public class JdbcInventoryDaoTests extends BaseDaoTests {
    ...
    public void retrieve_all_products() {
        ...
        Assert.assertEquals("Wrong number returned", 5,products.size());
        Assert.assertTrue(products.contains(CLOTHING_PRODUCT_1));
        Assert.assertTrue(products.contains(GROCERY_PRODUCT_1));
        Assert.assertTrue(products.contains(HOMEGOOD_PRODUCT_1));
        Assert.assertTrue(products.contains(BOOK_PRODUCT_1));
        Assert.assertTrue(products.contains(BOOK_PRODUCT_2));
    }
