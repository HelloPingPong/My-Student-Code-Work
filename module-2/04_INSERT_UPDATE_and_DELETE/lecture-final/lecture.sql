...
-- has an area of 2.1 square kilometers and does not offer camping.)
...
INSERT INTO city (city_name, population, state_abbreviation, area)
VALUES ('Hawkins', 30000, 'IN', 38.1), 
	   ('Cicely', 839, 'AK', 11.4);

-- Since Disneyland is in California (CA), add a record representing that to the park_state table.
INSERT INTO park_state (park_id, state_abbreviation) SELECT park_id, 'CA' FROM park WHERE park_name = 'Disneyland';
...
COMMIT;  -- Commit makes the changes final
