...
public class Exercise02_CanDrive {
    ...
    public boolean canDrive(boolean hasPermit, boolean withLicensedPassenger) {
        if (hasPermit == true && withLicensedPassenger == true) return true;
        else return false;
    }
     ...
     */
    public boolean canDrive(boolean driverHasPermit, boolean hasLicensedPassenger, int myPassengerAge, boolean isPassengerMyGuardian) {
        if (driverHasPermit == true && hasLicensedPassenger == true && ((myPassengerAge >= 18 && isPassengerMyGuardian == true) || ( myPassengerAge >=21 && isPassengerMyGuardian == false)))
        return true;
        else return false;
    }
}
