...
public class ExtraExercises<weekday> {
	...
	// aSmile = true && bSmile = bSmile = true = trouble (its true we are in trouble)
	// aSmile = false && bSmile = false = return true (its true we are in trouble)
	// if else = false
