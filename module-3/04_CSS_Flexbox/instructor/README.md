...
This is a collection of exercises that test your knowledge of flex container and flex item properties.  As discussed in class, this part is optional and will not be graded.  You only need to do part 2.  
