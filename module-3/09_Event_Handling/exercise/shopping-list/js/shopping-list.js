  ...
  groceries.forEach((name) => {
    ...
    function allItemsComplete() {
      ...
      button.addEventListener('click', () => {
        const checkCircle = document.querySelectorAll('li');
        checkCircle.forEach(element => {
          if (allItemsIncomplete) {
            element.firstElementChild.classList.add('completed');
            element.classList.add('completed');
            button.innerText = 'Mark All Incomplete'
          } else {
            element.firstElementChild.classList.remove('completed');
            element.classList.remove('completed');
            button.innerText = 'Mark All Complete'
          }
        });
        allItemsIncomplete = !allItemsComplete;
      });
    }})
