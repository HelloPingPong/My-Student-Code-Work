...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelector('p.description').addEventListener('click', (event) => {
...
function saveReview() {
  ...
  // Create a new review object from the values
  const newReview =   {
    reviewer: name,
    title: title,
    review: review,
  ...
  const isValid = validateReview(newReview);
  if (!isValid) {
  ...
  // call the displayReview method
  displayReview(newReview);

  // call the showHideForm method
  showHideForm();
}

function validateReview(newReview) {
  return newReview.reviewer && newReview.title && newReview.review && newReview.rating;
}
