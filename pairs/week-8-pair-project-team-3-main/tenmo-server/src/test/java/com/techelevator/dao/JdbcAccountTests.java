...
public class JdbcAccountTests extends BaseDaoTests{
    ...
    public void viewAccountBalance_returns_correct_balance() {
        Assert.assertEquals(ACCOUNT_1.getBalance(), sut.viewAccountBalance("user1"));
    }
    ...
    public void updateAccounts_updates_both_account_balances() {
        ...
        Assert.assertEquals(new BigDecimal("750.00"), sut.viewAccountBalance("user1"));
        Assert.assertEquals(new BigDecimal("1250.00"), sut.viewAccountBalance("user2"));
